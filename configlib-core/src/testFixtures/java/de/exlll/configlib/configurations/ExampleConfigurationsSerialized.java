...
public final class ExampleConfigurationsSerialized {
    ...
    public static final Map<String, ?> EXAMPLE_CONFIGURATION_A1 = initExampleConfigurationA1();
    public static final Map<String, ?> EXAMPLE_CONFIGURATION_A2 = initExampleConfigurationA2();

    public static Map<String, ?> initExampleConfigurationA1() {
        return entriesAsMap(
    ...
    public static Map<String, ?> initExampleConfigurationA2() {
        return extend(EXAMPLE_CONFIGURATION_A1,
