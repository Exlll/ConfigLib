...
dependencies { implementation("de.exlll:configlib-yaml:4.6.4") }
```
...
dependencies { implementation 'com.github.Exlll.ConfigLib:configlib-yaml:v4.6.4' }
```
